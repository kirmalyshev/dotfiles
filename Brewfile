...
brew "ankitpokhrel/jira-cli/jira-cli", trusted: true
...
brew "curl"
# Daytona CLI
brew "daytonaio/cli/daytona", trusted: true
...
go "github.com/hetznercloud/cli/cmd/hcloud"
